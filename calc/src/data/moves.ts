...
const RBY: {[name: string]: MoveData} = {
    ...
    'Bubble Barrage': { bp: 20, type: 'Water', multihit: 3 },
    ...
    'Burning Barrage': { bp: 20, type: 'Fire', multihit: 3 },
    Stomp: { bp: 70, type: 'Normal' },
    ...
    'Vine Lashes': { bp: 35, type: 'Grass', multihit:2 },
...
const ADV_PATCH: {[name: string]: DeepPartial<MoveData>} = {
    ...
    'Blaze Kick': { bp: 95, type: 'Fire', makesContact: true },
...
const BW_PATCH: {[name: string]: DeepPartial<MoveData>} = {
    ...
    Harmonize: { bp: 60, type: 'Normal', isSound: true, category: 'Special' },
    'Sacred Sword': {
        bp: 65,
        type: 'Fighting',
        makesContact: true,
...
const SM_PATCH: {[name: string]: DeepPartial<MoveData>} = {
    ...
    Flamethrower: { zp: 175 },
    'Flare Blitz': { zp: 195 },
    'Flash Cannon': { zp: 185, bp: 110 },
    Fling: { zp: 180 },
    Fly: { zp: 160, secondaries:true },
    'Flying Press': { bp: 125, zp: 200, secondaries:true },
    'Focus Blast': { zp: 200, bp: 130 },
    'Focus Punch': { zp: 230, willCrit:true },
    'Force Waves': { zp: 140 },
    'Foul Play': { zp: 175 },
