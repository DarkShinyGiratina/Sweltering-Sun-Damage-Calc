...
const RBY: { [name: string]: MoveData } = {
  ...
  "Double Kick": { bp: 35, type: "Fighting", multihit: 2 },
...
const SM_PATCH: { [name: string]: DeepPartial<MoveData> } = {
  ...
  "Cross Poison": { zp: 160 },
  Crunch: { zp: 170 },
  "Jagged Edge": { zp: 160, secondaries: true },
  ...
  "Vine Lashes": { zp: 160, secondaries: true },
  "Vise Grip": { zp: 100 },
